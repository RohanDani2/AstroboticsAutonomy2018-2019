...
typedef struct {
  ...
  real_T c12_mapGridP[741];
  boolean_T c12_mapGridP_not_empty;
  c12_emxArray_creal_T *c12_h;
  boolean_T c12_h_not_empty;
  real_T c12_roundedLimitUnique_data[2394];
  real_T c12_tmp_data[2394];
  real_T c12_costsTemp[2232];
  real_T c12_costs[2232];
  real_T c12_x[2232];
  real_T c12_mapList[2223];
  real_T c12_dv3[2223];
  ...
  creal_T c12_inflated_data[741];
  creal_T c12_b1_data[741];
  creal_T c12_b2_data[741];
  void *c12_fEmlrtCtx;
  real_T (*c12_pos)[2];
  real_T (*c12_b_costs)[2232];
  real_T *c12_theta;
  real_T (*c12_c_detectedList)[2162];
  real_T *c12_scale;
  real_T (*c12_goal)[2];
  real_T *c12_vehicleRad;
  real_T (*c12_limit)[348];
  real_T *c12_mode;
  real_T (*c12_mapGrid)[741];
