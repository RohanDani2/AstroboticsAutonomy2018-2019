...
MODEL                  = anav_real
MODULES                = rt_matrx.c rt_printf.c rt_logging.c anav_real.c anav_real_capi.c anav_real_data.c anav_real_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
MAKEFILE               = anav_real.mk
...
MASTER_ANCHOR_DIR      = 
START_DIR              = /Users/alex/Desktop/Astro/astrobotics_autonomy/simulink/anav_real
S_FUNCTIONS            = rtiostream_utils.c DstarRun.c Dstar.cpp DstarRun_wrapper.c
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/anav_real \
